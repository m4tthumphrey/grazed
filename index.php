...
<h2>You've had <?php echo $free_boxes ?> free boxes, saving a total of &pound;<?php echo number_format($discount, 2) ?>. That equates to about <?php echo number_format(floor($discount / $box_cost)) ?> free boxes overall!</h2>
...
<div class="clear"></div>
<h2>You received <?php echo count($old_products) ?> different foods that are no longer available and you've never received these <?php echo count($products_not_received) ?> foods!</h2>
<ul class="products">
